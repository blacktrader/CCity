...
void PROJECTILE::tick()
{
	...
	if((targetchr && (!game.controller->is_race() || (game.controller->is_race() && config.sv_enemy_damage))) || collide || lifespan < 0)
	{
		...
		else if(targetchr && (!game.controller->is_race() || (game.controller->is_race() && config.sv_enemy_damage)))
